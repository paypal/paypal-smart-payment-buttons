window.spbQRCode = function(modules) {
    ...
    function hooks_module_l(n) {
        return hooks_module_o = 1, function(n, r, o) {
            var i = function(t, r) {
                l.__h && l.__h(hooks_module_u, t, hooks_module_o || 2), hooks_module_o = 0;
    ...
    function DemoControls(_ref2) {
        ...
        return v("div", {
            ...
            authorized: "Reset",
            scanned: "Auth"
        }[processState || "null"]), v("button", {
            type: "button",
            onClick: function() {
                return setState_error();
            }
        }, "Show Error"), v("div", null, v("button", {
            type: "button",
            onClick: function() {
                setState_error();
            }
        }, "Set Error Value"), v("input", {
            type: "text",
            id: "errorMsg",
            value: errorMessage,
            onChange: function(e) {
    ...
    function QRCard(_ref3) {
        ...
        }, "Venmo account authorized"))), demo ? v(DemoControls, {
            cspNonce: cspNonce,
    ...
    function renderQRCode(_ref4) {
        ...
        var PropedCard = v(QRCard, {
            cspNonce: cspNonce,
            svgString: _ref4.svgString,
            demo: demo
        });
        u = demo ? function(component, cspNonce) {
            return v(d, null, v("style", {
                nonce: cspNonce
            }, "html{background-color: rgba(0, 0, 0, 0.4);}"), v("div", {
                style: "\n                background: #2F3033;\n                box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.4);\n                border-radius: 16px;                        \n                width: 720px;\n                height: 480px;  \n                display: flex;\n                align-items: center;\n                justify-content: center;\n                flex-direction: column;\n                position: relative;\n            }\n            "
            }, component));
        }(PropedCard, cspNonce) : PropedCard, i = function() {
